...
# cleaner = Cleaner(serie=pd.Series([10, 12, 14, 15, 16, 19, 20, 21, 22, 159, 180], index=pd.date_range(start="2022-01-01", end="2022-01-11"), name="value")


@pytest.mark.parametrize(
    "cleaner, output",
    [
        (Cleaner(serie=pd.Series([10, 12, 14, 15, 16, 19, 20, 21, 22, 159, 180],
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (Cleaner(pd.Series([0.047, 0.83, 0.91, 1.03, 0.62], index=pd.date_range(start="2022-02-12", end="2022-02-16"),
